...
class TestPlantRead:
    ...
    def test_get_other_users_plant_list(self, client, mock_db, default_user_plant):
    ...
    def test_read_your_plant(self, client, mock_db, default_user_plant):
        plant = default_user_plant
    ...
    def test_read_other_users_plant_ok(self, client, mock_db, default_user_plant):
        plant = default_user_plant
...
class TestPlantUpdate:
    def test_update(self, client, mock_db, default_user_plant):
        plant = default_user_plant
    ...
    def test_update_other_users_plant_fails(self, client, mock_db, default_user_plant):
        plant = default_user_plant
...
class TestPlantDelete:
    def test_delete(self, client, mock_db, default_user_plant):
        plant = default_user_plant
    ...
    def test_delete_other_users_plant_fails(self, client, mock_db, default_user_plant):
        plant = default_user_plant
