...
class TestPlantRead:
    ...
    def test_read_other_users_plant_ok(self, client, mock_db):
        plant_user_id = DEFAULT_TEST_USER.google_id
        plant_id = uuid.uuid4()
        plant = plant_record_factory(user_id=plant_user_id, plant_id=plant_id)
        mock_db.insert_mock_data(plant)
...
class TestPlantCreate:
    ...
    def test_create_with_duplicate_plant_id(self, client, mock_db):
        test_client = client(DEFAULT_TEST_USER)
        plant_id = uuid.uuid4()
        existing_plant = plant_record_factory(plant_id=plant_id, user_id=DEFAULT_TEST_USER.google_id)
        mock_db.insert_mock_data(existing_plant)
...
class TestPlantUpdate:
    def test_update(self, client, mock_db):
        plant_user_id = DEFAULT_TEST_USER.google_id
        plant_id = uuid.uuid4()
        plant = plant_record_factory(user_id=plant_user_id, plant_id=plant_id, human_name="Original Name")
        mock_db.insert_mock_data(plant)
    ...
    def test_update_other_users_plant_fails(self, client, mock_db):
        ...
        plant_id = uuid.uuid4()
        plant = plant_record_factory(user_id=plant_owner_id, plant_id=plant_id, human_name="Original Name")
        mock_db.insert_mock_data(plant)
    ...
    def test_update_cant_change_human_id(self, mock_db, client):
        plant_id = uuid.uuid4()
        plant = plant_record_factory(plant_id=plant_id, human_id=42)
        mock_db.insert_mock_data(plant)
...
class TestPlantDelete:
    ...
    def test_delete_other_users_plant_fails(self, client, mock_db):
        ...
        plant_owner_id = DEFAULT_TEST_USER.google_id
        plant_id = uuid.uuid4()
        plant = plant_record_factory(user_id=plant_owner_id, plant_id=plant_id)
        mock_db.insert_mock_data(plant)
